...
import com.rb.sss.service.ServDemo1017Service;
import com.rb.core.rest.ConfigIdentifier;
import com.rb.core.rest.GenericApi;

@Path("/api/v1/employees")
public class ServDemo1017Controller {

    public static final Logger logger = LoggerFactory.getLogger(ServDemo1017Controller.class);
	@Inject
	ServDemo1017Service service;
